...
\begin{figure}[htbp]\centering
	...
	\begin{subfigure}[b]{0.49\linewidth} %001005004.tif from 151113_Jess_TC_CCE_Rep2
		\begin{tikzpicture}[spy using outlines={rectangle,yellow,magnification=3,size=3cm, connect spies}]
...
A secondary validation of segmentation methods is established by the consistency of biological results achieved. For example, the consistency with other methods of experimental methods such as low-throughput microscopy or enzyme-linked immunosorbent assays (ELISA) may be assessed.
...
\begin{figure}[htbp]\centering
	\begin{subfigure}[b]{0.43\linewidth}
		\centering
		\includegraphics[width=\linewidth]{151002_Jess_sec_panel_4_exocytic_sites_bar}
		\caption{}
	...
	\begin{subfigure}[b]{0.43\linewidth}
		\centering
		\includegraphics[width=\linewidth]{151002_Jess_sec_panel_4_exocytic_sites_area}
		\caption{}
	...
	\begin{subfigure}[b]{\linewidth}
		\centering
		\includegraphics[width=\linewidth]{151002_Jess_sec_panel_4_exocytic_sites_hist_g}
		\caption{}
