\documentclass[draft,a4paper,twoside,PageStyleII,customMargin,11pt,numbered,index]{classes/PhDThesisPSnPDF}
...
\fi
\ifdefineChapter
	\includeonly{chapter_2/chapter_2, notes}
\fi
...
\listofmyequations
\cleardoublepage
\phantomsection\addcontentsline{toc}{chapter}{\protect\lstlistlistingname}
\lstlistoflistings
